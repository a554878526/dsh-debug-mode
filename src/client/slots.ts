...
// Type-only: pulls ui-conversation's SlotMap merge (the input-slot keys, the
// InputZone owner share, and the SessionStandardProps useInput/inputActions).
...
export type DebugModeDockProps =
  PropsRuntime<'conversation.input.dock'> & InjectFace<DebugModeDockInjected> & PropsStore<DebugModeStoreHandle>
