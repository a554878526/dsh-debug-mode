...
export const DEBUG_MODE_SKILL = {
    name: 'debug-mode',
    source: 'runtime',
    description: 'Runtime-first debug loop for the Debug Mode feature. When Debug Mode is active, every turn centers on runtime '
 ...
 */
export function debugModeSkill(scriptsDirectory) {
    return {
        ...DEBUG_MODE_SKILL,
